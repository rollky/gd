...
install_depend(){
    ...
    # 模块依赖
    pip3 install qrcode==7.3.1 Telethon==1.36.0 requests==2.27.1 Pillow==9.0.0 python-socks==1.2.4 async_timeout==4.0.2 prettytable==3.0.0
...
gitPull(){
    ...
    cd ${QLMainPath}/repo && rm -rf gd && git clone ${daili}https://github.com/rollky/gd.git
...
if [ -f ${QLMainPath}/jbot/user/user.py ];then
    echo -e "\n你已部署，请启动即可:\ncd ${QLMainPath}\npython3 -m jbot\n\n或参考本仓库第3-4步:\nhttps://github.com/rollky/gd/blob/main/README.md"
...
gitPull
echo -e "\n*******************\n所需环境已部署完成\n*******************\n"
echo -e "请前往面板【配置文件】配置tg机器人参数，再启动机器人即可。\n参考本仓库第3-4步: https://github.com/rollky/gd/blob/main/README.md "
